...
func IndirectNtMapViewOfSection(sectionHandle, processHandle uintptr, baseAddress *uintptr, commitSize uintptr, sectionOffset *int64, viewSize *uintptr, inheritDisposition uint32, allocationType uint32, win32Protect uint32) uint32 {
