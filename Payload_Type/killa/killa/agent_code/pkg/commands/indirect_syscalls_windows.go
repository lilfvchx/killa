...
func IndirectNtCreateSection(sectionHandle *uintptr, desiredAccess uint32, maximumSize *uint64, sectionPageProtection, allocationAttributes uint32, fileHandle uintptr) uint32 {
