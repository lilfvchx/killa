...
func IndirectNtCreateSection(sectionHandle *uintptr, desiredAccess uint32, objectAttributes uintptr, maximumSize *uint64, sectionPageProtection uint32, allocationAttributes uint32, fileHandle uintptr) uint32 {
