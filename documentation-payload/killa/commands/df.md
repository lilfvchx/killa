...
|----------|----------|---------|-------------|
| filesystem | No | â€” | Filter by device name (substring match) |
| mount_point | No | â€” | Filter by mount point path (substring match) |
| fstype | No | â€” | Filter by filesystem type (case-insensitive, e.g. 'ext4', 'ntfs') |
