...
|----------|----------|---------|-------------|
| destination | No | â€” | Filter by destination IP or subnet (substring match) |
| gateway | No | â€” | Filter by gateway IP (substring match) |
| interface | No | â€” | Filter by network interface name (case-insensitive) |
...
- Read-only enumeration â€” no modifications to the routing table
- Uses standard APIs and /proc filesystem â€” minimal footprint
