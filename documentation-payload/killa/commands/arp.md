...
|----------|----------|---------|-------------|
| ip | No | â€” | Filter by IP address (substring match, e.g. '192.168') |
| mac | No | â€” | Filter by MAC address (substring match, case-insensitive) |
| interface | No | â€” | Filter by interface name (case-insensitive exact match) |
