...
- **list** â€” Enumerate available event log channels with optional name filter
- **query** â€” Query events from a specific channel with XPath, EventID, or time filtering
- **clear** â€” Clear all events from a specific log channel (generates Event ID 1102)
- **info** â€” Display channel metadata: record count, file size, last write time
- **enable** â€” Enable an event log channel (start collecting events)
- **disable** â€” Disable an event log channel (stop collecting events)
...
- `list` â€” List available event log channels
- `query` â€” Query events from a channel
- `clear` â€” Clear a log channel
- `info` â€” Get channel information
- `enable` â€” Enable an event log channel
- `disable` â€” Disable an event log channel
...
- T1070.001 â€” Indicator Removal: Clear Windows Event Logs
- T1562.002 â€” Impair Defenses: Disable Windows Event Logging (disable action)
