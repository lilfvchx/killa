...
DNS enumeration command for host resolution, record queries, and domain controller discovery. Uses pure Go `net` package â€” no external dependencies, no subprocess execution.
...
[LDAP (Domain Controllers)] 1 found
  kingslanding.sevenkingdoms.local.:389 â†’ 192.168.100.51

[Kerberos (KDC)] 1 found
  kingslanding.sevenkingdoms.local.:88 â†’ 192.168.100.51

[Kerberos Password Change] 1 found
  kingslanding.sevenkingdoms.local.:464 â†’ 192.168.100.51

[Global Catalog] 2 found
  kingslanding.sevenkingdoms.local.:3268 â†’ 192.168.100.51
```
