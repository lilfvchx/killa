...
PrintSpoofer privilege escalation â€” one-step SeImpersonate to SYSTEM via the Print Spooler service.
...
- **GodPotato/DCOM-based** â€” uses DCOM activation, not affected by spooler patches
- **pipe-server** â€” generic pipe impersonation with external trigger
