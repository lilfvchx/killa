...
Manage BITS (Background Intelligent Transfer Service) transfer jobs for persistence and stealthy file download. BITS jobs survive reboots, transfer files using Windows' native BITS infrastructure, and can execute a command upon completion â€” making them useful for persistence.
