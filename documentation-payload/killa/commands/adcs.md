...
| `alt_name` | No | | Subject Alternative Name â€” UPN for ESC1 (e.g., `administrator@domain.local`) or DNS name |
...
Valid: 2026-03-04 12:00:00 â†’ 2027-03-04 12:00:00
```
...
- **ESC1 vs ESC6**: ESC1 requires a template with `ENROLLEE_SUPPLIES_SUBJECT` flag â€” the SAN is set in the CSR. ESC6 exploits the `EDITF_ATTRIBUTESUBJECTALTNAME2` CA flag â€” the SAN is set via request attributes regardless of template flags.
